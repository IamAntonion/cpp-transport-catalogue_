...
void MapRenderer::AddLine(std::vector<std::pair<Bus*, int>>& buses_palette) {
    ...
    for (auto [bus, palette] : buses_palette) { 
        ...
        for (Stop* stop : bus->stops) {
            ...
            coordinates.latitude = stop->coordinate.first;
            coordinates.longitude = stop->coordinate.second;
...
void MapRenderer::AddStopsCircle(std::vector<Stop*>& stops_name) {
    ...
    for (Stop* stop_info : stops_name) { 
        ...
        if (stop_info) {
            geo::Coordinates coordinates;
            coordinates.latitude = stop_info->coordinate.first;
            coordinates.longitude = stop_info->coordinate.second; 
